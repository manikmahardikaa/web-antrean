...
CREATE TABLE `User` (
    ...
    `id_layanan` VARCHAR(191) NULL,
    `id_tanggungan` VARCHAR(191) NULL,
...
CREATE TABLE `Tanggungan` (
    `id_tanggungan` VARCHAR(191) NOT NULL,
...
CREATE TABLE `Antrean` (
    `id_antrean` VARCHAR(191) NOT NULL,
    `id_user` VARCHAR(191) NOT NULL,
    `id_dokter` VARCHAR(191) NOT NULL,
    `id_layanan` VARCHAR(191) NOT NULL,
    `id_tanggungan` VARCHAR(191) NULL,
...
CREATE TABLE `BeritaKesehatan` (
    `id_berita` VARCHAR(191) NOT NULL,
